...
def upgrade() -> None:
    ...
    op.create_table(
        "artifacts",
        sa.Column("parent_id", servicekit.core.types.ULIDType(length=26), nullable=True),
        sa.Column("data", sa.PickleType(), nullable=False),
        sa.Column("level", sa.Integer(), nullable=False),
        sa.Column("id", servicekit.core.types.ULIDType(length=26), nullable=False),
    ...
    op.create_table(
        "config_artifacts",
        sa.Column("config_id", servicekit.core.types.ULIDType(length=26), nullable=False),
        sa.Column("artifact_id", servicekit.core.types.ULIDType(length=26), nullable=False),
